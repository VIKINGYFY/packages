...
| `luci-app-homeproxy` | `20260910-r2` | sing-box 核心的 LuCI 管理界面与 OpenWrt 集成。 | [VIKINGYFY/packages](https://github.com/VIKINGYFY/packages) |
...
| 软件包 | 版本 | 源码来源 |
| --- | --- | --- |
| `axonhub` | `20260910-r1` | [looplj/axonhub](https://github.com/looplj/axonhub) |
