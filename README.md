...
| `luci-app-homeproxy` | `20260808-r1` | sing-box 核心的 LuCI 管理界面与 OpenWrt 集成。 | [immortalwrt/homeproxy](https://github.com/immortalwrt/homeproxy) |
...
| 软件包 | 版本 | 源码来源 |
| --- | --- | --- |
| `axonhub` | `20260808-r1` | [looplj/axonhub](https://github.com/looplj/axonhub) |
