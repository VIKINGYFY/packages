...
if program_exists("/usr/bin/gecoosac") then
	m = Map("gecoosac", translate("Gecoos AC"), translate("Batch management Gecoos AP, Default password: admin") .. "<br>" .. translatef("The current AC version %s, only supports AP %s and above.","2.2","7.6"))
else
